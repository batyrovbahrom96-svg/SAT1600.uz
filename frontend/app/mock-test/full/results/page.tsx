...
const resultsCopy: Record<Language, {
  ...
  en: {
    ...
    monthlyPrice: "300,000 UZS",
    threeMonthPrice: "900,000 UZS",
    ...
    qrMonthlyAlt: "Paynet QR payment 300,000 UZS",
    qrThreeMonthAlt: "Paynet QR payment 900,000 UZS",
    noAnswer: "No answer",
  },
  ru: {
    ...
    qrMonthlyAlt: "Paynet QR оплата 300,000 UZS",
    qrThreeMonthAlt: "Paynet QR оплата 900,000 UZS",
    noAnswer: "Нет ответа",
  },
  uz: {
    ...
    qrMonthlyAlt: "Paynet QR to'lov 300,000 UZS",
    qrThreeMonthAlt: "Paynet QR to'lov 900,000 UZS",
    noAnswer: "Javob yo'q",
  },
};
