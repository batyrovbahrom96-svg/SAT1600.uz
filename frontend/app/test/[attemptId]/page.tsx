...
function ModuleOverScreen() {
  return (
    <main className="grid min-h-screen place-items-center bg-[#080908] px-8 text-center text-white">
      <section className="flex max-w-[760px] flex-col items-center">
        <h1 className="mb-12 text-[44px] font-light leading-tight text-white">
          This Module Is Over
        </h1>
        <p className="mb-8 text-[28px] leading-tight text-white/90">All your work has been saved.</p>
        <p className="mb-8 text-[28px] leading-tight text-white/90">You&apos;ll move on automatically in just a moment.</p>
        <p className="mb-28 text-[28px] leading-tight text-white/90">Do not refresh this page or quit the app.</p>
        <div className="h-28 w-28 animate-spin rounded-full border-[10px] border-transparent border-r-white border-t-white" aria-label="Loading next module" />
      </section>
    </main>
  );
}
