...
const learningEntryHref = "/learn";
const homepageCta = "Bepul boshlash →";
const partnerLogos = [
    ...
    >
        ...
        <div className="hero-proof-intro" data-sattest-no-translate="true">
          <div className="hero-proof-intro__copy">
            ...
            <div className="hero-proof-intro__actions">
              <PremiumButton className="nex-cta" href={learningEntryHref} icon={<ArrowRight size={18} />}>
                {homepageCta}
              </PremiumButton>
      ...
      <section className="top-score-proof-section" aria-labelledby="top-score-proof-title" data-sattest-no-translate="true">
        <div className="top-score-proof-section__copy">
          ...
          <PremiumButton className="top-score-proof-section__cta" href={learningEntryHref} icon={<ArrowRight size={18} />}>
            {homepageCta}
          </PremiumButton>
        </div>
      ...
      <section className="founder-trust-section" aria-labelledby="founder-trust-title">
        ...
        <div className="founder-trust-section__copy">
          ...
          <p>
            ...
            an IELTS 8.0 holder, and a 1540 SAT scorer. Doniyor Botirov is the founder of Mr. Doniyor Learning Center
          ...
          <div className="founder-trust-section__highlights">
            <div>
              ...
              <strong>Founder of SATTEST.UZ · 1540 SAT · IELTS 8.0</strong>
            </div>
            <div>
      ...
      <section className="platform-ad-section" aria-labelledby="platform-ad-title">
        <div className="platform-ad-section__copy">
          ...
          <Link className="platform-ad-section__cta" href={learningEntryHref}>
            <span>{homepageCta}</span>
            <ArrowRight size={18} />
          </Link>
        </div>
      ...
      <section className="parent-journey-section" aria-labelledby="parent-journey-title">
        <div className="parent-journey-section__intro">
          ...
          <PremiumButton className="parent-journey-section__cta" href={learningEntryHref} icon={<ArrowRight size={18} />}>
            {homepageCta}
          </PremiumButton>
        </div>
      ...
      <section className="homepage-faq-section" aria-labelledby="homepage-faq-title">
        <div className="homepage-faq-section__intro">
          ...
          <PremiumButton className="homepage-faq-section__cta" href={learningEntryHref} icon={<ArrowRight size={18} />}>
            {homepageCta}
          </PremiumButton>
        </div>
      ...
      <section className="mx-auto my-12 flex max-w-6xl flex-col items-center border border-[#FFD700]/25 bg-[#151515]/80 px-6 py-10 text-center shadow-[0_0_60px_rgba(255,215,0,0.08)] sm:px-10">
        <p className="text-xs font-black uppercase tracking-[0.32em] text-[#FFD700]">SATTEST.UZ Learning Platform</p>
        <h2 className="mt-4 max-w-3xl text-3xl font-black text-white sm:text-5xl">Bitta yo'l: diagnostika, shaxsiy reja va 1400+ sari harakat.</h2>
        <p className="mt-4 max-w-2xl text-base font-semibold leading-7 text-white/58">
          Barcha interaktiv testlar, Reading Analyzer, mock testlar va darslar endi yagona learning platform ichida.
        </p>
        <PremiumButton className="mt-7" href={learningEntryHref} icon={<ArrowRight size={18} />}>
          {homepageCta}
        </PremiumButton>
      </section>
