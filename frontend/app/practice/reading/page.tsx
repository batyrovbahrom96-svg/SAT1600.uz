        ...
        {!activeTopic ? (
          <>
            <div className="mt-8 border-b border-white/10 pb-10">
              ...
              <h1 className="mt-5 max-w-5xl text-5xl font-light leading-none md:text-7xl">Advanced Reading by question type.</h1>
            ...
            <div className="border border-white/10 bg-white/[0.035] p-5 md:p-8">
              {isFinished ? (
                <div className="flex min-h-[430px] flex-col justify-center">
                  ...
                  <p className="mt-5 max-w-2xl text-lg font-light leading-8 text-white/50">This advanced Reading set is finished.</p>
