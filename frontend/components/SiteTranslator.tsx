...
const ru: TranslationMap = {
  ...
  "Interactive AI layer": "Интерактивный AI-слой",
  "A smarter study companion for every diagnostic route.": "Более умный учебный помощник для каждого диагностического маршрута.",
  "The 3D assistant represents how SATTEST.UZ reads a mock test, detects weak skills, and turns the next study step into a clear action instead of another guess.": "3D-помощник показывает, как SATTEST.UZ анализирует пробный тест, находит слабые навыки и превращает следующий учебный шаг в понятное действие, а не в очередную догадку.",
...
const uz: TranslationMap = {
  ...
  "The 3D assistant represents how SATTEST.UZ reads a mock test, detects weak skills, and turns the next study step into a clear action instead of another guess.": "3D yordamchi SATTEST.UZ mock testni qanday tahlil qilishi, zaif ko'nikmalarni topishi va keyingi o'quv qadamini yana bir taxmin emas, aniq harakatga aylantirishini ko'rsatadi.",
