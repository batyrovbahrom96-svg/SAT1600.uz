...
const ru: TranslationMap = {
  ...
  "Answer 5 SAT-style questions. SATTEST.UZ will show a quick weakness snapshot, then you can create an account to save the full mock test.": "Ответьте на 5 вопросов в стиле SAT. SATTEST.UZ быстро покажет слабые места, затем вы сможете создать аккаунт и сохранить полный пробный тест.",
  "A researcher found that students who reviewed missed SAT questions improved faster than students who only watched new lessons. Which choice best states the finding?": "Исследователь обнаружил, что ученики, которые разбирали пропущенные SAT-вопросы, улучшались быстрее, чем ученики, которые только смотрели новые уроки. Какой вариант лучше всего передает вывод?",
  "New lessons are unnecessary for SAT improvement.": "Новые уроки не нужны для улучшения SAT.",
  "Reviewing mistakes can be more useful than only adding new content.": "Разбор ошибок может быть полезнее, чем только добавление нового материала.",
  "Students should stop taking full mock tests.": "Ученикам следует перестать проходить полные пробные тесты.",
  "SAT scores improve only when students study every day.": "SAT-баллы растут только тогда, когда ученики занимаются каждый день.",
  "Reading · Question 1 of 5": "Чтение · вопрос 1 из 5",
...
const uz: TranslationMap = {
  ...
  "Answer 5 SAT-style questions. SATTEST.UZ will show a quick weakness snapshot, then you can create an account to save the full mock test.": "SAT uslubidagi 5 ta savolga javob bering. SATTEST.UZ zaif joylarni tez ko'rsatadi, keyin to'liq sinov testini saqlash uchun akkaunt yaratishingiz mumkin.",
  "A researcher found that students who reviewed missed SAT questions improved faster than students who only watched new lessons. Which choice best states the finding?": "Tadqiqotchi o'tkazib yuborilgan SAT savollarini tahlil qilgan o'quvchilar faqat yangi darslarni ko'rgan o'quvchilarga qaraganda tezroq yaxshilanganini aniqladi. Qaysi javob bu xulosani eng yaxshi ifodalaydi?",
  "New lessons are unnecessary for SAT improvement.": "SAT natijasini oshirish uchun yangi darslar kerak emas.",
  "Reviewing mistakes can be more useful than only adding new content.": "Xatolarni tahlil qilish faqat yangi mavzu qo'shishdan foydaliroq bo'lishi mumkin.",
  "Students should stop taking full mock tests.": "O'quvchilar to'liq sinov testlarini topshirishni to'xtatishi kerak.",
  "SAT scores improve only when students study every day.": "SAT ballari faqat o'quvchilar har kuni o'qiganda oshadi.",
  "Reading · Question 1 of 5": "O'qish · 5 tadan 1-savol",
  "Command of Evidence": "Dalil bilan ishlash",
  "Your mini diagnostic snapshot": "Mini diagnostika natijangiz",
