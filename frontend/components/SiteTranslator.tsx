...
const ru: TranslationMap = {
  ...
  "The payment process is simple for now: pay by QR, send the receipt, and get access after confirmation. These are the questions students and parents usually ask first.": "Процесс оплаты простой: оплатите по QR, отправьте чек и получите доступ после подтверждения. Это вопросы, которые ученики и родители обычно задают первыми.",
  "Payment instruction": "Инструкция по оплате",
  "After payment, send the receipt to the Telegram bot with the email used during registration. Pro access opens after confirmation.": "После оплаты отправьте чек в Telegram-бот вместе с email, указанным при регистрации. Pro-доступ откроется после подтверждения.",
...
const uz: TranslationMap = {
  ...
  "The payment process is simple for now: pay by QR, send the receipt, and get access after confirmation. These are the questions students and parents usually ask first.": "To'lov jarayoni hozircha oddiy: QR orqali to'lang, chekni yuboring va tasdiqdan keyin kirish oling. Bu o'quvchilar va ota-onalar avval so'raydigan savollar.",
  "Payment instruction": "To'lov yo'riqnomasi",
  "After payment, send the receipt to the Telegram bot with the email used during registration. Pro access opens after confirmation.": "To'lovdan keyin chekni ro'yxatdan o'tishda ishlatilgan email bilan Telegram botga yuboring. Pro kirish tasdiqdan keyin ochiladi.",
