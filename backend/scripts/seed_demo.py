...
def math_module1_bluebook_question(index: int) -> QuestionSpec:
    graph_value_payload = {
        ...
        "series": [
            {
                "name": "Tablet value",
                "values": [[0, 225], [6, 145], [12, 100], [18, 70], [24, 50]],
            }
        ],
    }
    graph_tutoring_payload = {
        "graph_pattern": "crossover_point",
        "question_intent": "claim_support",
        "prompt_template": "same_cost_intersection",
        "reasoning_type": "intercept_meaning",
        "x_label": "Hours of tutoring",
        "y_label": "Total cost (dollars)",
        "series": [
            {"name": "Plan A", "values": [[0, 20], [2, 44], [4, 68], [6, 92]]},
            {"name": "Plan B", "values": [[0, 44], [2, 56], [4, 68], [6, 80]]},
        ],
    }
    graph_launch_payload = {
        "graph_pattern": "divergence",
        "question_intent": "trend_description",
    ...
    questions: tuple[dict, ...] = (
        {
            "topic": "Algebra",
            "subtopic": "Linear equation modeling",
            "question_type": "linear_equation",
            "prompt": "Amira bought a sketchbook for $4 and several markers that cost $1.75 each. If she spent $14.50 total, which equation can be used to find $m$, the number of markers she bought?",
            "correct": "A",
            "explanation": "The total is the fixed sketchbook cost plus $1.75 for each marker, so the exact model is 1.75m + 4 = 14.50.",
            "trap_type": "fixed cost versus variable cost trap",
            "choices": math_choices("$1.75m + 4 = 14.50$", "$1.75m - 4 = 14.50$", "$1.75 + 4m = 14.50$", "$4m - 1.75 = 14.50$", correct="A"),
        },
        {
            "topic": "Algebra",
            "subtopic": "Ratio relationships",
            "question_type": "ratio_scaling",
            "prompt": "The ratio $x$ to $y$ is equivalent to the ratio 7 to 4. If $x = 154$, what is the value of $y$?",
            "correct": "C",
            "explanation": "Because x:y = 7:4, 154 corresponds to 7 parts. One part is 22, so y is 4(22) = 88.",
            "trap_type": "ratio order trap",
            "choices": math_choices("77", "84", "88", "110", correct="C"),
        },
        {
            "topic": "Advanced Math",
            "subtopic": "Function notation",
            "question_type": "function_interpretation",
            "prompt": "The function $f$ is defined by $f(x) = 18x + 24$. What is the value of $f(x)$ when $x = 3$?",
            "correct": "C",
            "explanation": "Substitute 3 for x: f(3) = 18(3) + 24 = 78.",
            "trap_type": "substitution trap",
            "choices": math_choices("42", "54", "78", "96", correct="C"),
        },
        {
            "topic": "Geometry and Trigonometry",
            "subtopic": "Congruent figures",
            "question_type": "geometry",
            "prompt": "Triangles PQR and STU are congruent, where P, Q, and R correspond to S, T, and U, respectively. The measure of angle P is 38 degrees and the measure of angle Q is 67 degrees. What is the measure of angle S?",
            "correct": "B",
            "explanation": "Corresponding angles in congruent triangles are equal. Since P corresponds to S, angle S measures 38 degrees.",
            "trap_type": "correspondence mapping trap",
            "choices": math_choices("29 degrees", "38 degrees", "75 degrees", "113 degrees", correct="B"),
        },
        {
            "topic": "Data Analysis",
            "subtopic": "Graph interpretation",
            "question_type": "graph_reasoning",
            "prompt": "The graph shown gives the estimated value, in dollars, of a tablet as a function of the number of months since it was purchased. What is the best interpretation of the y-intercept of the graph in this context?",
            "correct": "A",
            "explanation": "The y-intercept is the value when the number of months after purchase is 0, so it represents the estimated purchase-time value of $225.",
            "trap_type": "intercept context trap",
            "choices": math_choices("The estimated value of the tablet was $225 when it was purchased.", "The estimated value of the tablet 24 months after it was purchased was $225.", "The estimated value of the tablet had decreased by $225 in the 24 months after it was purchased.", "The estimated value of the tablet decreased by approximately 2.25% each year after it was purchased.", correct="A"),
            "graph_payload": graph_value_payload,
        },
        {
            "topic": "Algebra",
            ...
            "correct": "B",
            "explanation": "Subtract 47 from both sides to get |p| = 5, so 5 is one solution.",
            "trap_type": "absolute value solution trap",
            "choices": math_choices("$\\frac{52}{47}$", "5", "99", "104", correct="B"),
        },
        {
            "topic": "Problem Solving and Data Analysis",
            "subtopic": "Interpreting coefficients",
            ...
            "correct": "D",
            "explanation": "The coefficients show that square tokens are worth 80 points and circle tokens are worth 90 points. The difference is exactly 10 points.",
            "trap_type": "coefficient meaning trap",
            "choices": math_choices("950", "90", "80", "10", correct="D"),
        },
        {
            "topic": "Data Analysis",
            "subtopic": "Linear graph comparison",
            "question_type": "graph_reasoning",
            "prompt": "A tutoring company offers two payment plans. The graph shows the total cost, in dollars, for each plan after h hours of tutoring. Which statement about the graph best supports the conclusion that the two plans cost the same for one number of tutoring hours?",
            "correct": "B",
            "explanation": "Two plans cost the same at the point where their graphs intersect; here, the intersection occurs when the total cost is $68.",
            "trap_type": "intersection versus intercept trap",
            "choices": math_choices("Plan A always costs less than Plan B.", "The two lines intersect when the total cost is $68.", "Plan B starts with the lower initial cost.", "The cost of Plan A increases by $12 for every 2 hours, while Plan B decreases.", correct="B"),
            "graph_payload": graph_tutoring_payload,
        },
        {
            "topic": "Advanced Math",
            "subtopic": "Rational equations",
            "question_type": "rational_equation_trap",
            "prompt": "$\\frac{(x + 8)(x - 8)}{x + 8} = 6$, where $x \\ne -8$.\n\nWhat is the solution to the given equation?",
            "correct": "C",
            "explanation": "Since x is not -8, the factor x + 8 can be canceled, leaving x - 8 = 6. Thus x = 14.",
            "trap_type": "cancellation domain trap",
            "choices": math_choices("6", "8", "14", "48", correct="C"),
        },
        {
            "topic": "Advanced Math",
            "subtopic": "Rearranging formulas",
            "question_type": "expression_rewrite",
            "prompt": "The equation $15n + a = b$ relates the variables $n$, $a$, and $b$. Which expression is equivalent to $b - a$ in terms of $n$?",
            "correct": "D",
            "explanation": "Subtract a from both sides of 15n + a = b to get b - a = 15n.",
            "trap_type": "isolate expression not variable trap",
            "choices": math_choices("$\\frac{n}{15}$", "$n$", "$n + \\frac{1}{15}$", "$15n$", correct="D"),
        },
        {
            "topic": "Problem Solving and Data Analysis",
            "subtopic": "Scale factors",
            "question_type": "ratio_scaling",
            "prompt": "On a scale drawing, 2 centimeters represents 35 meters. A garden path is 6 centimeters long on the drawing. What is the actual length, in meters, of the garden path?",
            "correct": "B",
            "explanation": "Six centimeters is 3 times 2 centimeters, so the actual length is 3(35) = 105 meters.",
            "trap_type": "scale factor trap",
            "choices": math_choices("70", "105", "120", "210", correct="B"),
        },
        {
            "topic": "Advanced Math",
            "subtopic": "Function notation",
            "question_type": "function_interpretation",
            "prompt": "The function $f$ is defined by $f(x) = 5\\left(\\frac{1}{4} - x\\right)^2 + \\frac{11}{4}$. What is the value of $f\\left(\\frac{1}{4}\\right)$?",
            "correct": "2.75",
        ...
        },
        {
            ...
            "correct": "D",
            "explanation": "Adding the equations eliminates y and gives 0 = 13x - 6, so x = 6/13. Therefore 39x = 18.",
            "trap_type": "elimination and requested expression trap",
            "choices": math_choices("-18", "-6", "6", "18", correct="D"),
        },
        {
            "topic": "Advanced Math",
            "subtopic": "Exponential functions",
            "question_type": "function_interpretation",
            "prompt": "The function $f(t) = 40,000(2)^{\\frac{t}{790}}$ gives the number of bacteria in a population $t$ minutes after an initial observation. How much time, in minutes, does it take for the number of bacteria in the population to double?",
            "correct": "B",
        ...
        },
        {
            ...
            "choices": math_choices("When $f(x) = 0$, the number is $-\\frac{19}{4}$.", "When the number is 0, $f(x) = 19$.", "The value of $f(x)$ increases by 1 for each increase of 4 in the value of the number.", "For each increase of 1 in the value of the number, $f(x)$ increases by 4.", correct="A"),
        },
        {
            "topic": "Geometry and Trigonometry",
            "subtopic": "Trigonometric identities",
            "question_type": "geometry",
            "prompt": "Which of the following expressions is equivalent to $(\\sin 24^\\circ)(\\cos 66^\\circ) + (\\cos 24^\\circ)(\\sin 66^\\circ)$?",
            "correct": "C",
            ...
            "choices": math_choices("$2(\\cos 66^\\circ)(\\sin 24^\\circ)$", "$2(\\cos 66^\\circ) + 2(\\cos 24^\\circ)$", "$(\\cos 66^\\circ)^2 + (\\cos 24^\\circ)^2$", "$(\\cos 66^\\circ)^2 + (\\sin 24^\\circ)^2$", correct="C"),
        },
    )
...
def math_module2_bluebook_question(index: int) -> QuestionSpec:
    ...
    questions: tuple[dict, ...] = (
        ...
        },
        {
            ...
            "choices": math_choices("$M(t) = 890\\left(\\frac{1}{2}\\right)^{\\frac{t}{10}}$", "$M(t) = 890\\left(\\frac{1}{10}\\right)^{\\frac{t}{2}}$", "$M(t) = 890(2)^{\\frac{t}{10}}$", "$M(t) = 890(10)^{\\frac{t}{2}}$", correct="C"),
        },
        {
            "topic": "Algebra",
        ...
        },
        {
            ...
            "subtopic": "Function notation",
            "question_type": "function_interpretation",
            "prompt": "The function $f$ is defined by $f(x) = \\frac{1}{2}(x + 6)$. What is the value of $f(4)$?",
            "correct": "D",
        ...
        },
        {
            ...
            "choices": math_choices("$-2$", "$-\\frac{5}{6}$", "$\\frac{5}{6}$", "$2$", correct="D"),
        },
        {
            "topic": "Algebra",
