...
MATH_MODULE1_SPECS: tuple[MathQuestionSpec, ...] = (
    ...
    MathQuestionSpec(
        ...
        "For $x \\ne -9$, what is the solution to the equation $\\frac{(x + 9)(x - 9)}{x + 9} = 7$?",
        "C",
    ...
    MathQuestionSpec(
        ...
        "The function $f$ is defined by $f(x) = 5\\left(\\frac{1}{4} - x\\right)^2 + \\frac{11}{4}$. What is the value of $f\\left(\\frac{1}{4}\\right)$? Enter the decimal equivalent.",
        "2.75",
    ...
    MathQuestionSpec(
        ...
        (
            MathChoiceSpec("A", "When $f(x) = 0$, the number is $-\\frac{19}{4}$."),
    ...
    MathQuestionSpec(
        ...
        "exponential growth",
        "exponential_growth",
        "The function $f(t) = 40,000(2)^{\\frac{t}{790}}$ gives the number of bacteria in a population $t$ minutes after an initial observation. How many minutes does it take for the number of bacteria in the population to double?",
        "B",
    ...
    MathQuestionSpec(
        ...
        "One solution to $2x^2 - 8x - 7 = 0$ can be written as $\\frac{8 - \\sqrt{k}}{4}$, where $k$ is a constant. What is the value of $k$?",
        "120",
    ...
    MathQuestionSpec(
        ...
        "trig_identity",
        "Which expression is equivalent to $(\\sin 24^\\circ)(\\cos 66^\\circ) + (\\cos 24^\\circ)(\\sin 66^\\circ)$?",
        "D",
        "The expression has the form sin a cos b + cos a sin b = sin(a + b). Since 24 + 66 = 90, the value is sin 90 degrees = 1.",
        (
            MathChoiceSpec("A", "$2(\\cos 66^\\circ)(\\sin 24^\\circ)$"),
            MathChoiceSpec("B", "$2(\\cos 66^\\circ) + 2(\\cos 24^\\circ)$"),
            MathChoiceSpec("C", "$(\\cos 66^\\circ)^2 + (\\sin 24^\\circ)^2$"),
            MathChoiceSpec("D", "1"),
        ),
        difficulty=7,
        estimated_time=90,
    ...
    MathQuestionSpec(
        ...
        "rational equation",
        "rational_equation_trap",
        "For $x \\ne -6$, what is the solution to $\\frac{(x + 6)(3x - 4)}{x + 6} = 17$?",
        "7",
