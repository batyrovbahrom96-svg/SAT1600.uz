...
CREATE TABLE IF NOT EXISTS test_attempts (
  ...
  module1_correct INTEGER NOT NULL DEFAULT 0,
  module1_total INTEGER NOT NULL DEFAULT 0,
  module2_mode VARCHAR(16) NOT NULL DEFAULT 'medium',
  module2_started BOOLEAN NOT NULL DEFAULT FALSE,
  module2_correct INTEGER NOT NULL DEFAULT 0,
  module2_total INTEGER NOT NULL DEFAULT 0,
...
CREATE INDEX IF NOT EXISTS ix_subscriptions_status_period ON subscriptions(status, current_period_end);
CREATE INDEX IF NOT EXISTS ix_subscriptions_provider_customer ON subscriptions(provider_customer_id);

CREATE INDEX IF NOT EXISTS ix_questions_sat_routing ON questions(test_id, section, module, adaptive_level, difficulty);
